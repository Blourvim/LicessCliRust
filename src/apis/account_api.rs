...
/// struct for typed errors of method [`account_email`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountEmailError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`account_kid`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountKidError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`account_kid_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountKidPostError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`account_me`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`timeline`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
) -> Result<crate::models::Account200Response, Error<AccountError>> {
...
pub async fn account_email(
    configuration: &configuration::Configuration,
) -> Result<crate::models::AccountEmail200Response, Error<AccountEmailError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/account/email", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountEmailError> =
...
pub async fn account_kid(
    configuration: &configuration::Configuration,
) -> Result<crate::models::AccountKid200Response, Error<AccountKidError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/account/kid", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountKidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn account_kid_post(
    configuration: &configuration::Configuration,
    v: bool,
) -> Result<crate::models::Ok, Error<AccountKidPostError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.query(&[("v", &v.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountKidPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn account_me(
    configuration: &configuration::Configuration,
) -> Result<crate::models::UserExtended, Error<AccountMeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountMeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn timeline(
    ...
    since: Option<i32>,
    nb: Option<i32>,
) -> Result<crate::models::Timeline, Error<TimelineError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/timeline", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimelineError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
            entity: local_var_entity,
