...
/// struct for typed errors of method [`api_user_following`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiUserFollowingError {
...
pub async fn api_user_following(configuration: &configuration::Configuration, ) -> Result<crate::models::UserExtended, Error<ApiUserFollowingError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/rel/following", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiUserFollowingError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn follow_user(configuration: &configuration::Configuration, username: &str) -> Result<crate::models::Ok, Error<FollowUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/rel/follow/{username}", local_var_configuration.base_path, username=crate::apis::urlencode(username));
...
pub async fn unfollow_user(configuration: &configuration::Configuration, username: &str) -> Result<crate::models::Ok, Error<UnfollowUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/rel/unfollow/{username}", local_var_configuration.base_path, username=crate::apis::urlencode(username));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
