...
impl ToString for PerfType {
    fn to_string(&self) -> String {
        match self {
            Self::UltraBullet => String::from("ultraBullet"),
            Self::Bullet => String::from("bullet"),
            Self::Blitz => String::from("blitz"),
            Self::Rapid => String::from("rapid"),
            Self::Classical => String::from("classical"),
            Self::Correspondence => String::from("correspondence"),
            Self::Chess960 => String::from("chess960"),
            Self::Crazyhouse => String::from("crazyhouse"),
            Self::Antichess => String::from("antichess"),
            Self::Atomic => String::from("atomic"),
            Self::Horde => String::from("horde"),
            Self::KingOfTheHill => String::from("kingOfTheHill"),
            Self::RacingKings => String::from("racingKings"),
            Self::ThreeCheck => String::from("threeCheck"),
        }
    }
}

impl Default for PerfType {
    fn default() -> PerfType {
        Self::UltraBullet
    }
}
