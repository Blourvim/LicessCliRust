...
pub struct ApiExternalEngineAnalyseRequest {
...
impl ApiExternalEngineAnalyseRequest {
    pub fn new(client_secret: String, work: crate::models::ExternalEngineWork) -> ApiExternalEngineAnalyseRequest {
