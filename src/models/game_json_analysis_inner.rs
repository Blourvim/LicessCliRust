...
pub struct GameJsonAnalysisInner {
    /// Evaluation in centipawns
    #[serde(rename = "eval", skip_serializing_if = "Option::is_none")]
    pub eval: Option<f32>,
    /// Number of moves until forced mate
    #[serde(rename = "mate", skip_serializing_if = "Option::is_none")]
    pub mate: Option<f32>,
    ...
    #[serde(rename = "judgment", skip_serializing_if = "Option::is_none")]
    pub judgment: Option<Box<crate::models::GameJsonAnalysisInnerJudgment>>,
}

impl GameJsonAnalysisInner {
    pub fn new() -> GameJsonAnalysisInner {
