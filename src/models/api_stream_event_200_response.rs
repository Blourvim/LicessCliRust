...
pub struct ApiStreamEvent200Response {
    #[serde(
        rename = "type",
        default,
    ...
    pub game: Option<Box<crate::models::GameEventInfo>>,
    #[serde(rename = "challenge", skip_serializing_if = "Option::is_none")]
    pub challenge: Option<Box<crate::models::ChallengeCanceledJson>>,
}

impl ApiStreamEvent200Response {
    pub fn new() -> ApiStreamEvent200Response {
