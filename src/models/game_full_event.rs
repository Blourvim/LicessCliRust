...
pub struct GameFullEvent {
    ...
    #[serde(rename = "clock", deserialize_with = "Option::deserialize")]
...
impl GameFullEvent {
    pub fn new(r#type: String, id: String, variant: crate::models::Variant, clock: Option<crate::models::Clock>, speed: crate::models::Speed, perf: crate::models::GameFullEventPerf, rated: bool, created_at: f32, white: crate::models::GameEventPlayer, black: crate::models::GameEventPlayer, initial_fen: String, state: crate::models::GameStateEvent) -> GameFullEvent {
        GameFullEvent {
            r#type,
            id,
            variant: Box::new(variant),
            clock: if let Some(x) = clock {Some(Box::new(x))} else {None},
            speed,
            perf: Box::new(perf),
            rated,
            created_at,
