...
pub struct TeamPaginatorJson {
    #[serde(rename = "currentPage", skip_serializing_if = "Option::is_none")]
    pub current_page: Option<f32>,
    #[serde(rename = "maxPerPage", skip_serializing_if = "Option::is_none")]
    pub max_per_page: Option<f32>,
    #[serde(rename = "currentPageResults", skip_serializing_if = "Option::is_none")]
    pub current_page_results: Option<Vec<crate::models::Team>>,
    #[serde(rename = "nbResults", skip_serializing_if = "Option::is_none")]
    pub nb_results: Option<f32>,
    #[serde(rename = "previousPage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub previous_page: Option<Option<f32>>,
    #[serde(rename = "nextPage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub next_page: Option<Option<f32>>,
    #[serde(rename = "nbPages", skip_serializing_if = "Option::is_none")]
    pub nb_pages: Option<f32>,
}

impl TeamPaginatorJson {
    pub fn new() -> TeamPaginatorJson {
        TeamPaginatorJson {
            current_page: None,
            max_per_page: None,
