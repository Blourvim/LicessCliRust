...
pub struct ChallengeUser {
    ...
    #[serde(rename = "provisional", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub provisional: Option<Option<serde_json::Value>>,
    #[serde(rename = "online", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub online: Option<Option<serde_json::Value>>,
...
impl ChallengeUser {
    pub fn new(id: Option<serde_json::Value>, name: Option<serde_json::Value>) -> ChallengeUser {
        ChallengeUser {
            rating: None,
            provisional: None,
            online: None,
