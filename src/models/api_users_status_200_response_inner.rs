...
pub struct ApiUsersStatus200ResponseInner {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
    ...
    #[serde(rename = "patron", skip_serializing_if = "Option::is_none")]
    pub patron: Option<bool>,
}

impl ApiUsersStatus200ResponseInner {
    pub fn new(id: String, name: String) -> ApiUsersStatus200ResponseInner {
