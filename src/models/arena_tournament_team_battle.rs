...
pub struct ArenaTournamentTeamBattle {
    #[serde(rename = "teams", skip_serializing_if = "Option::is_none")]
    pub teams: Option<Vec<String>>,
    #[serde(rename = "nbLeaders", skip_serializing_if = "Option::is_none")]
    pub nb_leaders: Option<i32>,
}

impl ArenaTournamentTeamBattle {
    pub fn new() -> ArenaTournamentTeamBattle {
