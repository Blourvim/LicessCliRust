...
/// GameJsonAnalysisInnerJudgment : Judgment annotation (only if played move was inaccurate)



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GameJsonAnalysisInnerJudgment {
...
impl GameJsonAnalysisInnerJudgment {
    /// Judgment annotation (only if played move was inaccurate)
    pub fn new() -> GameJsonAnalysisInnerJudgment {
