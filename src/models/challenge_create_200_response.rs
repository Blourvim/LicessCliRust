...
pub struct ChallengeCreate200Response {
    #[serde(rename = "challenge", skip_serializing_if = "Option::is_none")]
    pub challenge: Option<Box<crate::models::ChallengeJson>>,
}

impl ChallengeCreate200Response {
    pub fn new() -> ChallengeCreate200Response {
        ChallengeCreate200Response {
            challenge: None,
        }
    }
}
