...
pub struct ApiExternalEngineAnalyse200ResponsePvsInner {
...
impl ApiExternalEngineAnalyse200ResponsePvsInner {
    pub fn new(depth: i32, moves: Vec<String>) -> ApiExternalEngineAnalyse200ResponsePvsInner {
