...
pub struct GameJsonPlayers {
    #[serde(rename = "white", skip_serializing_if = "Option::is_none")]
    pub white: Option<Box<crate::models::GameUser>>,
    #[serde(rename = "black", skip_serializing_if = "Option::is_none")]
    pub black: Option<Box<crate::models::GameUser>>,
}

impl GameJsonPlayers {
    pub fn new() -> GameJsonPlayers {
        GameJsonPlayers {
            white: None,
            black: None,
        }
