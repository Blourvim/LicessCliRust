...
pub struct Perfs {
    #[serde(rename = "chess960", skip_serializing_if = "Option::is_none")]
    pub chess960: Option<Box<crate::models::Perf>>,
    #[serde(rename = "atomic", skip_serializing_if = "Option::is_none")]
    pub atomic: Option<Box<crate::models::Perf>>,
    #[serde(rename = "racingKings", skip_serializing_if = "Option::is_none")]
    pub racing_kings: Option<Box<crate::models::Perf>>,
    #[serde(rename = "ultraBullet", skip_serializing_if = "Option::is_none")]
    pub ultra_bullet: Option<Box<crate::models::Perf>>,
    #[serde(rename = "blitz", skip_serializing_if = "Option::is_none")]
    pub blitz: Option<Box<crate::models::Perf>>,
    #[serde(rename = "kingOfTheHill", skip_serializing_if = "Option::is_none")]
    pub king_of_the_hill: Option<Box<crate::models::Perf>>,
    #[serde(rename = "bullet", skip_serializing_if = "Option::is_none")]
    pub bullet: Option<Box<crate::models::Perf>>,
    #[serde(rename = "correspondence", skip_serializing_if = "Option::is_none")]
    pub correspondence: Option<Box<crate::models::Perf>>,
    #[serde(rename = "horde", skip_serializing_if = "Option::is_none")]
    pub horde: Option<Box<crate::models::Perf>>,
    #[serde(rename = "puzzle", skip_serializing_if = "Option::is_none")]
    pub puzzle: Option<Box<crate::models::Perf>>,
    #[serde(rename = "classical", skip_serializing_if = "Option::is_none")]
    pub classical: Option<Box<crate::models::Perf>>,
    #[serde(rename = "rapid", skip_serializing_if = "Option::is_none")]
    pub rapid: Option<Box<crate::models::Perf>>,
    #[serde(rename = "storm", skip_serializing_if = "Option::is_none")]
    pub storm: Option<Box<crate::models::PuzzleModePerf>>,
    #[serde(rename = "racer", skip_serializing_if = "Option::is_none")]
    pub racer: Option<Box<crate::models::PuzzleModePerf>>,
    #[serde(rename = "streak", skip_serializing_if = "Option::is_none")]
    pub streak: Option<Box<crate::models::PuzzleModePerf>>,
}
