...
pub struct ExternalEngineRegistration {
    ...
    pub variants: Option<Vec<crate::models::UciVariant>>,
...
impl ExternalEngineRegistration {
    pub fn new(name: String, max_threads: i32, max_hash: i32, default_depth: i32, provider_secret: String) -> ExternalEngineRegistration {
