...
pub struct ApiSimul200Response {
    #[serde(rename = "pending", skip_serializing_if = "Option::is_none")]
    pub pending: Option<Vec<serde_json::Value>>,
    ...
    pub started: Option<Option<serde_json::Value>>,
    #[serde(rename = "finished", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub finished: Option<Option<serde_json::Value>>,
}

impl ApiSimul200Response {
    pub fn new() -> ApiSimul200Response {
        ApiSimul200Response {
            pending: None,
            created: None,
            started: None,
