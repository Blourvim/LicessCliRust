...
pub struct ExternalEngineWork {
    ...
    pub variant: crate::models::UciVariant,
...
impl ExternalEngineWork {
    pub fn new(session_id: String, threads: i32, hash: i32, multi_pv: i32, variant: crate::models::UciVariant, initial_fen: String, moves: Vec<String>) -> ExternalEngineWork {
        ExternalEngineWork {
            session_id,
            threads,
            hash,
