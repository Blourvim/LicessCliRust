...
/// GameStatus : Game status code. https://github.com/lichess-org/scalachess/blob/0a7d6f2c63b1ca06cd3c958ed3264e738af5c5f6/src/main/scala/Status.scala#L16-L28
...
impl ToString for GameStatus {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::Mate => String::from("mate"),
            Self::Resign => String::from("resign"),
            Self::Stalemate => String::from("stalemate"),
            Self::Timeout => String::from("timeout"),
            Self::Draw => String::from("draw"),
            Self::Outoftime => String::from("outoftime"),
            Self::Cheat => String::from("cheat"),
            Self::NoStart => String::from("noStart"),
            Self::UnknownFinish => String::from("unknownFinish"),
            Self::VariantEnd => String::from("variantEnd"),
        }
    }
}
