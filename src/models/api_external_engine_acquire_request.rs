...
pub struct ApiExternalEngineAcquireRequest {
    #[serde(rename = "providerSecret", skip_serializing_if = "Option::is_none")]
    pub provider_secret: Option<String>,
}

impl ApiExternalEngineAcquireRequest {
    pub fn new() -> ApiExternalEngineAcquireRequest {
